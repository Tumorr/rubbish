...
class Player:
    ...
    def userChoice(self):
        ...
        try:
            app.addButton("Confirm3",Player.userChoiceConfirm)
            
        except ValueError:
            app.showButon("Confirm3")
    ...
    def getNameCont(self):
        ...
        #When there were multiple words inside of each set of brackets, I encountered errors - this was the simplest solution
        app.setLabel("text",("Thank","You",user,"!","We","look","forward","to","your","return!","Now","go!"))
        app.hideEntry("input_")
        app.addButton("Confirm2",Player.userChoice)
...
class Map:
    ...
    def move(self):
        app.clearEntry("input_")
        app.hideButton("Confirm3")
        app.addButton("Confirm4",Map.direction)
